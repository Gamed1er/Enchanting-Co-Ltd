...
execute store result score @s EnchantmentsHunger run data get entity @s foodLevel 1
...
execute if score @s EnchantmentsHunger matches ..10 run scoreboard players set @e[tag = EnchantmentFoodBeggarTmpV] EnchantmentsFoodBeggarCoolDown 120
execute if score @s EnchantmentsHunger matches ..16 run scoreboard players set @e[tag = EnchantmentFoodBeggarTmpV] EnchantmentsFoodBeggarCoolDown 180
execute unless score @s EnchantmentsHunger matches ..16 run scoreboard players set @e[tag = EnchantmentFoodBeggarTmpV] EnchantmentsFoodBeggarCoolDown 300
