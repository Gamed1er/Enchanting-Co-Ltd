...
execute if score @s EnchantmentsTeleportEnderEnergy matches 3.. unless score @s EnchantmentsTeleportCoolDown matches 1.. at @s if block ^ ^ ^0.7 air run tp @s ^ ^ ^0.5
execute if score @s EnchantmentsTeleportEnderEnergy matches 3.. unless score @s EnchantmentsTeleportCoolDown matches 1.. at @s if block ^ ^ ^0.7 air run tp @s ^ ^ ^0.5
execute if score @s EnchantmentsTeleportEnderEnergy matches 3.. unless score @s EnchantmentsTeleportCoolDown matches 1.. at @s if block ^ ^ ^0.7 air run tp @s ^ ^ ^0.5
execute if score @s EnchantmentsTeleportEnderEnergy matches 3.. unless score @s EnchantmentsTeleportCoolDown matches 1.. at @s if block ^ ^ ^0.7 air run tp @s ^ ^ ^0.5
execute if score @s EnchantmentsTeleportEnderEnergy matches 3.. unless score @s EnchantmentsTeleportCoolDown matches 1.. at @s if block ^ ^ ^0.7 air run tp @s ^ ^ ^0.5
...
execute unless score @s EnchantmentsTeleportCoolDown matches 1.. run scoreboard players set @s EnchantmentsTeleportCoolDown 24
