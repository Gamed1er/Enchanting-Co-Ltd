...
execute as @a if predicate enchantments:teleport_setting unless predicate enchantments:teleport_setting2 run item modify entity @s weapon.mainhand enchantments:teleport_setting
