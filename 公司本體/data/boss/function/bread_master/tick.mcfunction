...
execute if score @s BossVariable1 matches 20 if entity @a[distance = ..6] run damage @p 6 arrow by @s from @s
execute if score @s BossVariable1 matches 20 if entity @a[distance = ..6] run effect give @n hunger 1200 5 false
...
effect give @e[type = iron_golem, distance = ..5] weakness 60 4