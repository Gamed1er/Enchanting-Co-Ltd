...
execute if score Random QuestTrigger matches 0 run scoreboard players set @s QuestID 2101
...
execute if score Random QuestTrigger matches 0 run function company:quests/message/start/2101
